...
import com.ayanami.okoyo.service.OrdersService;
import com.ayanami.okoyo.entity.Order;
import com.ayanami.okoyo.entity.OrderBasket;
import com.ayanami.okoyo.entity.OrderType;
...
public class OrderController {
    ...
    public String createOrders(Model model, Principal principal) {
        if (principal != null) {
            ...
            model.addAttribute("waiting", OrderType.Waiting.name());
    ...
    private void sendVerificationEmail(Order order)
        ...
        String subject = "Thank you for ordering in OKOYO";
        String senderName = "OKOYO-Store";
        ...
        helper.setFrom("kawaiistore00@outlook.com", senderName);
